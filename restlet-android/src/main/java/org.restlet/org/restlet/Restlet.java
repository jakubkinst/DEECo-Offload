...
public abstract class Restlet implements Uniform {
     ...
     * security reasons.
     * 
     * @see org.restlet.Context#createChildContext()
     * 
     * @param context
     ...
     * {@link org.restlet.resource.Finder#createFinder(Class, Class, org.restlet.Context, java.util.logging.Logger)}
     ...
     * @see org.restlet.resource.Finder#createFinder(Class, Class, org.restlet.Context,
     ...
     * {@link #handle(org.restlet.Request, Response)}.
     * 
     * @param request
     ...
     * setting the current context using the {@link org.restlet.Context#setCurrent(org.restlet.Context)}
     ...
     * is set to {@link org.restlet.data.Status#SERVER_ERROR_INTERNAL}.
     * <p>
