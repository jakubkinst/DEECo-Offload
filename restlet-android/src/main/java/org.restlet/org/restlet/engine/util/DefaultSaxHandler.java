...
/**
 * A Utility class which extends the provided {@link org.xml.sax.helpers.DefaultHandler} and
...
public class DefaultSaxHandler extends DefaultHandler
{
    ...
    /** The current context JDK {@link java.util.logging.Logger} to use for message output. */
