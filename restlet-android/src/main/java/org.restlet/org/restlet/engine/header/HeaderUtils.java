...
public class HeaderUtils {
     ...
     * {@link org.restlet.util.Series}.
     * 
     * @param entity
     *            The source entity {@link Representation}.
     * @param headers
     *            The target headers {@link org.restlet.util.Series}.
     */
    ...
    /**
     * Adds the general headers from the {@link Message} to the {@link org.restlet.util.Series}.
     * 
     * @param message
    ...
    /**
     * Adds the entity headers based on the {@link Representation} to the
     * {@link org.restlet.util.Series} when a 304 (Not Modified) status is returned.
     * 
     * @param entity
     *            The source entity {@link Representation}.
     * @param headers
    ...
    /**
     * Adds the headers based on the {@link Request} to the given {@link org.restlet.util.Series}
     * .
     * 
     * @param request
     *            The {@link Request} to copy the headers from.
     * @param headers
     *            The {@link org.restlet.util.Series} to copy the headers to.
     */
     ...
     * @see org.restlet.engine.header.HeaderUtils#copyResponseTransportHeaders(org.restlet.util.Series, Response)
     */
