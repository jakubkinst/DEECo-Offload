...
public final class MediaType extends Metadata {
     ...
     * {@link #includes(org.restlet.data.Metadata, boolean)}. It ignores the parameters.
     * 
     * @param included
     *            The media type to test for inclusion.
     * @return True if the given media type is included in the current one.
     * @see #isCompatible(org.restlet.data.Metadata)
     */
    @Override
    ...
    /**
     * Indicates if a given media type is included in the current one @see
     * {@link #includes(org.restlet.data.Metadata, boolean)}. The test is true if both types are
