...
public abstract class ChallengeMessage {
    ...
    /**
     * Returns the digest algorithm. See {@link org.restlet.data.Digest} class for DIGEST_*
     * constants. Default value is {@link org.restlet.data.Digest#ALGORITHM_MD5}.
     * 
    ...
    /**
     * Sets the digest algorithm. See {@link org.restlet.data.Digest} class for ALGORITHM_*
     * constants. Default value is {@link org.restlet.data.Digest#ALGORITHM_MD5}.
     * 
     * @param digestAlgorithm
     *            The digest algorithm.
