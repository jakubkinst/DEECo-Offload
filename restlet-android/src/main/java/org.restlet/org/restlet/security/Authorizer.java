 ...
 * downstream {@link Restlet} and {@link org.restlet.resource.ServerResource} objects.
 * 
...
public abstract class Authorizer extends Filter {
     ...
     * {@link org.restlet.data.Status#CLIENT_ERROR_UNAUTHORIZED} instead of the default
     * {@link org.restlet.data.Status#CLIENT_ERROR_FORBIDDEN}.
     * 
     * @see org.restlet.data.ClientInfo#isAuthenticated()
     */
    ...
    /**
     * Invoked upon successful authorization. Returns {@link org.restlet.routing.Filter#CONTINUE} by
     * default.
     * 
     * @param request
     *            The request sent.
     ...
     * {@link org.restlet.data.Status#CLIENT_ERROR_FORBIDDEN} and returns {@link org.restlet.routing.Filter#STOP} by
     * default.
     * 
     * @param request
     *            The request sent.
