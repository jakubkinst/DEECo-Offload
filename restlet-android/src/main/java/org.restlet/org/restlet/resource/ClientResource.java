 ...
 * This class changes the semantics of the {@link org.restlet.resource.Resource#getRequest()} and
 * {@link org.restlet.resource.Resource#getResponse()} methods. Since a clientResource may receive
...
public class ClientResource extends Resource {
     ...
     * {@link org.restlet.resource.ClientResource} and invokes the {@link #wrap(Class)} method.
     * 
     * @param <T>
     * @param context
     *            The context.
     ...
     * @see org.restlet.data.ClientInfo#accept(org.restlet.data.Metadata...)
     */
     ...
     * @param quality
     *            The quality to set.
     * @see org.restlet.data.ClientInfo#accept(org.restlet.data.Metadata, float)
     */
     ...
     * @see org.restlet.data.Reference#addQueryParameter(org.restlet.data.Parameter)
     */
     ...
     * @return The updated reference.
     * @see org.restlet.data.Reference#addQueryParameter(String, String)
     */
     ...
     * @return The updated reference.
     * @see org.restlet.data.Reference#addQueryParameters(Iterable)
     */
     ...
     * @return The updated reference.
     * @see org.restlet.data.Reference#addSegment(String)
     */
     ...
     * identical to {@link #get(org.restlet.data.MediaType)} but doesn't return the actual
     ...
     * {@link #handle(Request, Response, java.util.List, int, Uniform)} method invoked.
     * 
     * @param request
     *            The request to send.
     * @param response
     ...
     *            server.
     * @see Request#setChallengeResponse(org.restlet.data.ChallengeResponse)
     */
     ...
     * @see Request#setClientInfo(org.restlet.data.ClientInfo)
     */
     ...
     * @see Request#setConditions(org.restlet.data.Conditions)
     */
     ...
     * @see Request#setCookies(org.restlet.util.Series)
     */
     ...
     * @see org.restlet.resource.ClientResource#setRequestEntityBuffering(boolean)
     ...
     * @param hostRef
     *            The host reference.
     * @see Request#setHostRef(org.restlet.data.Reference)
     */
     ...
     * @param method
     *            The method called.
     * @see Request#setMethod(org.restlet.data.Method)
     */
     ...
     * @see Request#setOriginalRef(org.restlet.data.Reference)
     */
     ...
     *            origin server.
     * @see Request#setProxyChallengeResponse(org.restlet.data.ChallengeResponse)
     */
     ...
     * @param ranges
     *            The ranges.
     * @see Request#setRanges(java.util.List)
     */
     ...
     * @see Request#setResourceRef(org.restlet.data.Reference)
     */
     ...
     * @see Request#setReferrerRef(org.restlet.data.Reference)
     */
