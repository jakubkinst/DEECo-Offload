 ...
 * variables. For a complete list of properties, please see the {@link org.restlet.util.Resolver}
...
public class Redirector extends Restlet {
     ...
     * {@link org.restlet.data.Status#REDIRECTION_PERMANENT} status. Note: this is a client-side
     * redirection.<br>
     * 
     ...
     * the target URI pattern using the {@link org.restlet.data.Status#REDIRECTION_FOUND} status.
    ...
    /**
     * In this mode, the client is simply redirected to the URI generated from
     * the target URI pattern using the {@link org.restlet.data.Status#REDIRECTION_SEE_OTHER}
     ...
     * from the target URI pattern using the
     * {@link org.restlet.data.Status#REDIRECTION_TEMPORARY} status. Note: this is a client-side
     * redirection.<br>
     * 
     ...
     * {@link org.restlet.routing.Redirector} as acting as a transparent server-side proxy. Note:
     ...
     * URI template variables found using the {@link org.restlet.routing.Template} class using the
