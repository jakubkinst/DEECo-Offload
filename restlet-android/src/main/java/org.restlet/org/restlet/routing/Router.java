...
public class Router extends Restlet {
     ...
     * {@link org.restlet.util.RouteList#getBest(Request, Response, float)} method for
     ...
     * {@link org.restlet.util.RouteList#getFirst(Request, Response, float)} method for
     * implementation details.
     */
     ...
     * {@link org.restlet.util.RouteList#getLast(Request, Response, float)} method for
     * implementation details.
     */
     ...
     * {@link org.restlet.util.RouteList#getNext(Request, Response, float)} method for
     * implementation details.
     */
     ...
     * {@link org.restlet.util.RouteList#getRandom(Request, Response, float)} method for
     * implementation details.
     */
     ...
     * typically the selected {@link org.restlet.routing.Route}. By default, it just invokes the
     * next Restlet.
     * 
     * @param next
     ...
     * {@link Directory} or {@link org.restlet.routing.Router} then the mode returned is
     * {@link Template#MODE_STARTS_WITH} to allow further routing by those
     * objects. If the target is an instance of {@link org.restlet.routing.Filter}, then it returns
     * the matching mode for the {@link org.restlet.routing.Filter#getNext()} Restlet recursively.
     * 
     * @param target
     *            The target Restlet.
