 ...
 * overridden or returns null, the {@link org.restlet.data.Status#SERVER_ERROR_INTERNAL} constant
 * will be set by default.<br>
 * <br>
 * Also, when the status of a response returned is an error status (see
 * {@link org.restlet.data.Status#isError()}, the
 * {@link #getRepresentation(org.restlet.data.Status, Request, Response)} method is then invoked
...
public class StatusService extends Service {
     ...
     * @deprecated Use {@link #toRepresentation(org.restlet.data.Status, Request, Response)}
     *             instead.
     */
    @Deprecated
     ...
     * {@link org.restlet.data.Status#SERVER_ERROR_INTERNAL} status and logs a severe message.<br>
     * In order to customize the default behavior, this method can be
     * overridden.
     * 
     * @param throwable
     ...
     * {@link Throwable} representation if the throwable is annotated
     ...
     * {@link #toRepresentation(org.restlet.data.Status, Request, Response)}
     * 
     * @param status
     *            The status to represent.
     * @param resource
