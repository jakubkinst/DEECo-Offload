...
public class MetadataService extends Service {
    ...
    /**
     * Constructor. Sets the default language to {@link org.restlet.data.Language#ENGLISH_US},
     * the default encoding to {@link org.restlet.data.Encoding#IDENTITY} (no encoding) and the
     * default media type to {@link org.restlet.data.MediaType#APPLICATION_OCTET_STREAM}. It also
