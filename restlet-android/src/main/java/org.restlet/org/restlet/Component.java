...
/**
 * Restlet managing a set of {@link Connector}s, {@link org.restlet.routing.VirtualHost}s,
 * {@link org.restlet.service.Service}s and {@link Application}s. Applications are expected to be
...
public class Component extends Restlet {
     ...
     * {@link org.restlet.Context#getServerDispatcher()} method, but the internal router is
     ...
     * defined via the {@link #setLogService(org.restlet.service.LogService)} method, then a default
     ...
     * @param statusService
     *            The status service.
     * @deprecated Use {@link Application#setStatusService(org.restlet.service.StatusService)}
     *             instead.
     */
    @Deprecated
