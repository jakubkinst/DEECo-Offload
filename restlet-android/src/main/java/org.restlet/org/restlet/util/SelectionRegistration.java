 ...
 * channel. For the operation codes, see the constants in {@link java.nio.channels.SelectionKey}.
 * 
...
public class SelectionRegistration {
     ...
     * {@link java.nio.channels.Selector} for the {@link #getInterestOperations()} operations.
     * 
     * @param selector
     ...
     * {@link #getSelectableChannel()} with the given {@link java.nio.channels.Selector} for the
