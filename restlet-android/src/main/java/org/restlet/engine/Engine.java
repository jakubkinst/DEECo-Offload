 ...
 * replace it by providing an alternate {@link org.restlet.engine.log.LoggerFacade} implementation. For
...
public class Engine {
    ...
    /**
     * Sets the general log level. Modifies the global JVM's {@link java.util.logging.LogManager}.
     * 
     * @param logLevel
     *            The general log level.
     */
