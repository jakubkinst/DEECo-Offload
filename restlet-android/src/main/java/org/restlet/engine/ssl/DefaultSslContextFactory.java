...
/**
 * This {@link org.restlet.engine.ssl.SslContextFactory} makes it possible to configure most basic
 * options when building an SSLContext. See the {@link #init(org.restlet.util.Series)} method for
...
public class DefaultSslContextFactory extends SslContextFactory {
     ...
     * 
     * @see javax.net.ssl.SSLContext#init(javax.net.ssl.KeyManager[],
    ...
    /**
     * Creates a new {@link javax.net.ssl.SSLContext} wrapper. Necessary to properly
     * initialize the {@link javax.net.ssl.SSLEngine} or {@link javax.net.ssl.SSLSocketFactory} or
     ...
     */
    protected SSLContext createWrapper(
