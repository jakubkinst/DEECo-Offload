...
/**
 * Selection listener notifying new content is read into a {@link java.nio.ByteBuffer}.
 * 
...
public abstract class ReadingListener implements SelectionListener {
     ...
     * exception at the {@link java.util.logging.Level#WARNING} level.
     * 
     * @param ioe
     ...
     * {@link #onContent(java.nio.ByteBuffer)} method or the {@link #onEnd()} method or
     * the {@link #onError(java.io.IOException)} method.
     */
