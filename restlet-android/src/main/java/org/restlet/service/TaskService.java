 ...
 * instance, you can use the {@link org.restlet.service.TaskService#wrap(java.util.concurrent.ScheduledExecutorService)}
...
public class TaskService extends Service implements ScheduledExecutorService {
     ...
     * calls {@link java.util.concurrent.Executors#newCachedThreadPool(java.util.concurrent.ThreadFactory)}, passing the
     ...
     * {@link java.util.concurrent.ExecutorService} interface for typing details.
     * 
     * @param tasks
     *            The task to execute.
