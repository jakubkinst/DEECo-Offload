 ...
 * {@link org.restlet.routing.VirtualHost} that served them. This class is both a descriptor able to
...
public class Application extends Restlet {
     ...
     * ClientResource. In general, instances of {@link org.restlet.routing.Router} and
     * {@link java.util.logging.Filter} classes will be used. The default implementation returns a
     * Restlet giving access to the the outbound service layer and finally to
     * the {@link org.restlet.Context#getClientDispatcher()}.
     * <p>
     ...
     *            The client root {@link org.restlet.resource.ServerResource} subclass.
     */
