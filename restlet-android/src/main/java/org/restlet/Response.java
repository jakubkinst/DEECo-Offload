...
public class Response extends Message {
     ...
     * {@link org.restlet.Restlet#handle(Request, Response)} method.
     * 
     ...
     * <br>
     * Note that this calls back {@link org.restlet.Request#commit(org.restlet.Response)} on the parent
     ...
     * that this calls back {@link org.restlet.Request#flushBuffers()} on the parent request
     ...
     * {@link org.restlet.data.Status#isInformational()} method.
     * 
     ...
     * {@link org.restlet.Request#getResourceRef()} and {@link org.restlet.data.Reference#getBaseRef()}.
     * 
     * @param targetUri
     *            The target URI.
     */
     ...
     * reference (see {@link org.restlet.Request#getResourceRef()} and
     * {@link org.restlet.data.Reference#getBaseRef()}.<br>
     * <br>
     * Note that when used with HTTP connectors, this property maps to the
     * "Location" header.
     * 
     * @param locationUri
     *            The URI to set.
     * @see #setLocationRef(org.restlet.data.Reference)
     */
     ...
     * {@link java.util.concurrent.CopyOnWriteArrayList} for example. Note that when used with HTTP
