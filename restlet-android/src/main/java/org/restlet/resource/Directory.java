 ...
 * {@link #getIndexRepresentation(Variant, org.restlet.data.ReferenceList)} method, unless the
 * "listingAllowed" property is turned off. You can even customize the way the
 * index entries are sorted by using the {@link #setComparator(java.util.Comparator)}
...
public class Directory extends Finder {
     ...
     * @see org.restlet.engine.util.AlphaNumericComparator
     */
