...
public abstract class Representation extends RepresentationInfo {
     ...
     * request and the underlying connections using the {@link org.restlet.Request#abort()}
     * method or a shortcut one like
     * {@link org.restlet.resource.ServerResource#abort()} or
     * {@link org.restlet.Response#abort()}.
     */
    public void release() {
        setAvailable(false);
    }
     ...
     * <br>
     * Note that the class implementing this method shouldn't flush or close the
     * given {@link java.io.OutputStream} after writing to it as this will be handled by
