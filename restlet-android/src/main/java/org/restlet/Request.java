...
public class Request extends Message {
     ...
     * {@link org.restlet.Context#getClientDispatcher()} or
     * {@link org.restlet.Context#getServerDispatcher()}, if the reference contains URI
    ...
    /**
     * Implemented based on the {@link org.restlet.data.Protocol#isConfidential()} method for the
     ...
     * @param referrerUri
     *            The referrer URI.
     * @see #setReferrerRef(org.restlet.data.Reference)
     */
     ...
     * @param resourceUri
     *            The resource URI.
     * @see #setResourceRef(org.restlet.data.Reference)
     */
