 ...
 * and the secret from the {@link org.restlet.data.ChallengeResponse}. If the verification is
 * successful, it automatically adds a new {@link org.restlet.security.User} for the given
 * identifier.
 * 
...
public abstract class SecretVerifier implements Verifier {
     ...
     * @return The {@link org.restlet.security.User} instance created.
     */
     ...
     * response with the one obtain by the {@link org.restlet.data.ChallengeResponse#getSecret()}
     * method and sets the {@link User} instance of the
     * request's {@link org.restlet.data.ClientInfo} if successful.
     * 
     * @param request
     *            The request to inspect.
     * @param response
