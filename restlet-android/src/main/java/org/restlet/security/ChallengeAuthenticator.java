 ...
 * 
 * @see org.restlet.data.ChallengeScheme
 * @see org.restlet.data.ChallengeRequest
...
public class ChallengeAuthenticator extends Authenticator {
     ...
     *            The authentication realm.
     * 
     * @see #ChallengeAuthenticator(Context, boolean, org.restlet.data.ChallengeScheme, String,
     ...
     * {@link org.restlet.data.ClientInfo#setAuthenticated(boolean)} method is invoked.
     */
    @Override
