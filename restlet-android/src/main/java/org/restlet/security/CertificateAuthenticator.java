 ...
 * 
 * {@link #getPrincipals(java.util.List)} and {@link #getUser(java.security.Principal)} can be
...
public class CertificateAuthenticator extends Authenticator {
     ...
     * returned from this chain by {@link #getPrincipals(java.util.List)} to the request's
     * ClientInfo and set the user to the result of {@link #getUser(java.security.Principal)}
