 ...
 * following a {@link org.restlet.data.ChallengeRequest} sent by the origin server to the client.<br>
 * <br>
...
public final class ChallengeResponse extends ChallengeMessage {
     ...
     *            The digest algorithm of the user secret (see {@link org.restlet.data.Digest}
     *            class).
     */
    public ChallengeResponse(ChallengeRequest challengeRequest,
            Response response, String identifier, char[] secret,
