...
public class TemplateRoute extends Route {
     ...
     * {@link org.restlet.routing.Template#MODE_STARTS_WITH} matching mode. This can be changed by
     * getting the template and calling {@link org.restlet.routing.Template#setMatchingMode(int)}
     * with {@link org.restlet.routing.Template#MODE_EQUALS} for exact matching.
     * 
     * @param router
     *            The parent router.
     * @param uriTemplate
